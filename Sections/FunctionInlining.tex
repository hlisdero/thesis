...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.28]{two-function-calls-incorrect-1.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.28]{two-function-calls-incorrect-2.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.25]{two-function-calls-correct.png}
...
on the frequency with which functions are re-used on average in the codebase.
