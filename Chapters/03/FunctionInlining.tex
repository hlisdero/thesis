...
\begin{figure}[!htbp]
    \centering
    \includesvg[width=0.9\linewidth]{two-function-calls-incorrect-1.svg}
...
\begin{figure}[!htbp]
    \centering
    \includesvg[width=0.9\linewidth]{two-function-calls-incorrect-2.svg}
...
\begin{figure}[!htbp]
    \centering
    \includesvg[width=0.9\linewidth]{two-function-calls-correct.svg}
