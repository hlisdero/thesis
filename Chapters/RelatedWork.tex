...
Colored Petri nets (CPNs) are a type of Petri net that can represent
...
named \emph{Nondeterministic Transitioning Petri nets} (NT-Petri nets),
which allows transitions to fire
