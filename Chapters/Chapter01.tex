...
\begin{itemize}
    ...
    \item Community-driven: Rust has a vibrant and growing community of developers
          ...
          in form of RFCs (\emph{Requests for Comments})\footnote{\url{https://rust-lang.github.io/rfcs/}}.
\end{itemize}
...
The core idea behind the borrow checker is that each piece of memory in a Rust program has an owner.
...
\begin{itemize}
    \item The Android Open Source Project encourages the use of Rust for the SO components
          below the Android Runtime (ART) \cite{stoep2021}.
