...
El objetivo general del trabajo consiste en estudiar la posibilidad de extender el compilador de Rust
para detectar deadlocks en tiempo de compilación debidos a un uso incorrecto de mutexes
...
\begin{center}
    ...
    \begin{tabular}{ |l|c|c|c|c|c|c|c|c|c|c|c|c| }
        ...
        \hline
        Implementación de la traducción                   &                             &                  &                  & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} &                  &                  \\
        \hline
